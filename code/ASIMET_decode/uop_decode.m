...
experiment = 'SHS';
deployment = 'lab_2';
dumpname   = '20260521_SHS-test_EGH';  % directory where all output will go
tstart = datenum(2026,05,19);              % Time range of plots
tend = datenum(2026,05,21);
...
WXT_SD_files = {'ASWXT102'};             % WXTs (SD version); must have .DAT extension (do not include here)
